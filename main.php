...
function CoderMark() {
 ...
 │  ██████╔╝██║  ██║██║  ██║██║  ██╗                        │
 │  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝                        │
 │                                                          │{$Colors['am']}{{$Colors['rt']}dark life 🧬 {$Colors['am']}}{$Colors['rt']}
 │                                                          │
 ╰─━━━━━━━━━━━━━━━━━━━━━━━━Termux-os━━━━━━━━━━━━━━━━━━━━━━━─╯
\n{$Colors['rt']}{$Colors['gb']} OpenLoop Bot {$Colors['gl']}PHP {$Colors['bl']}v1.0 {$Colors['rt']}
    \n{$Colors['gr']}――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
    \n{$Colors['yl']}[+]{$Colors['rt']} DM : {$Colors['bl']}https://t.me/scripthub00
    \n{$Colors['yl']}[+]{$Colors['rt']} GH : {$Colors['bl']}https://github.com/Mittyadav/
    \n{$Colors['gr']}――――――――――――――――――――――――――――――――――――――――――――――――――
